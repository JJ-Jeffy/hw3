...
cmake --build .
salloc -N 8 -n 64 -A mp309 -t 10:00 --qos=interactive -C cpu srun -N 1 -n 1 ./kmer_hash_19 /global/cfs/cdirs/mp309/cs267-spr2020/hw3-datasets/smaller/small.txt test
